 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://ws.demo.com/", wsdlLocation = "http://localhost:8080/Demo_Web_Service/NewWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://ws.demo.com/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Demo_Web_Service/NewWebService?WSDL");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://ws.demo.com/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.demo.com/", "NewWebServicePort"), NewWebService.class, features);
    }
