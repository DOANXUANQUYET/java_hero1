...
public class Main {
    ...
    static {
        ...
        //file xml chua thong tin ket noi voi database , META-INF - persistence.xml
         emf = Persistence.createEntityManagerFactory("Day_la_chuoi_tu_file_XML");
    ...
    public static void main(String[] args) {
       ...
       // Query cQuery = em.createQuery("SELECT s FROM SanPham s ",them jieu du lieutra ve);
        ...
        SanPhamJpaController control = new SanPhamJpaController(emf);
        List<SanPham> listsp = control.findSanPhamEntities();
        listsp.forEach((t) -> {
            System.out.println(t);
        });
