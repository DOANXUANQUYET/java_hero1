...
public class StudentView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabStudent.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "ID", "Name", "Date of birth", "Address", "E-mail", "AVG"
            }
        ));
        jScrollPane1.setViewportView(tabStudent);
        if (tabStudent.getColumnModel().getColumnCount() > 0) {
            tabStudent.getColumnModel().getColumn(1).setResizable(false);
            tabStudent.getColumnModel().getColumn(6).setResizable(false);
        }
